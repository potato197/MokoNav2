...
public interface BetterActivity {
    ...
    AlertDialog newYesNoDialog(int titleResourceId, int messageResourceId,
                               OnClickListener listener);

    AlertDialog newInfoDialog(int titleResourceId, int messageResourceId);

    AlertDialog newAlertDialog(int titleResourceId, int messageResourceId);
     ...
     * @return the dialog
     */
    AlertDialog newErrorHandlerDialog(int titleResourceId, Exception error);
     ...
     * @return the dialog
     */
    AlertDialog newErrorHandlerDialog(Exception error);
     ...
     * @return the dialog
     */
    <T> Dialog newListDialog(String title, final List<T> listItems,
